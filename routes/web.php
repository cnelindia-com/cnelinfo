...
Route::get('/tools/user-agent-parser', 'ToolController@userAgentParser')->middleware('verified')->name('tools.user_agent_parser');
Route::post('/tools/user-agent-parser', 'ToolController@processUserAgentParser')->middleware('verified');
...
Route::get('/tools/website-ping', 'ToolController@base64Converter')->middleware('verified')->name('tools.base64_converter');
Route::post('/tools/base64-converter', 'ToolController@processBase64Converter')->middleware('verified');
Route::get('/tools/dns-lookup', 'ToolController@dnsLookup')->middleware('verified')->name('tools.dns_lookup');
Route::post('/tools/dns-lookup', 'ToolController@processDnsLookup')->middleware('verified');
Route::get('/tools/whois-lookup', 'ToolController@whoisLookup')->middleware('verified')->name('tools.whois_lookup');
Route::post('/tools/whois-lookup', 'ToolController@processWhoisLookup')->middleware('verified');
Route::get('/tools/ssl-checker', 'ToolController@sslChecker')->middleware('verified')->name('tools.ssl_checker');
Route::post('/tools/ssl-checker', 'ToolController@processSslChecker')->middleware('verified');
Route::get('/tools/website-status-checker', 'ToolController@websiteStatusChecker')->middleware('verified')->name('tools.website_status_checker');
Route::post('/tools/website-status-checker', 'ToolController@processWebsiteStatusChecker')->middleware('verified');
Route::get('/tools/keyword-generator', 'ToolController@keywordGenerator')->middleware('verified')->name('tools.keyword_generator');
Route::post('/tools/keyword-generator', 'ToolController@processKeywordGenerator')->middleware('verified');
Route::get('/tools/serp-checker', 'ToolController@serpChecker')->middleware('verified')->name('tools.serp_checker');
Route::post('/tools/serp-checker', 'ToolController@processSerpChecker')->middleware('verified');
Route::get('/tools/indexed-pages-checker', 'ToolController@indexedPagesChecker')->middleware('verified')->name('tools.indexed_pages_checker');
Route::post('/tools/indexed-pages-checker', 'ToolController@processIndexedPagesChecker')->middleware('verified');
