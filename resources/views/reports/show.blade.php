    ...
    <div class="card border-0 shadow-sm overflow-hidden">
        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                @if(config('settings.screenshot'))
                    <div class="col-12 col-lg-auto d-flex justify-content-center d-lg-block">
                        <img src="//image.thum.io/get{{ config('settings.screenshot_key') ? '/auth/' . config('settings.screenshot_key') : '' }}/width/504/crop/760/{{ $report->fullUrl }}" width="252px" class="rounded mt-3 mt-lg-0">
                    </div>
                @endif
            </div>
        </div>
