            ...
            <div class="list-group list-group-flush my-n3">
                <div class="list-group-item px-0">
                    <div class="row align-items-center text-muted">
                        <div class="col-lg-12 col-6 text-truncate">{{ __('Type') }}</div>
                        <div class="col-lg-12 col-6 text-truncate">{{ __('Number') }}</div>
                    </div>
                </div>

                <div class="list-group-item px-0">
                    <div class="row align-items-center">
                        <div class="col-lg-12 col-6 text-truncate">{{ __('Words') }}</div>
                        <div class="col-lg-12 col-6 text-truncate">{{ number_format($wordCount, 0, __('.'), __(',')) }}</div>
                    </div>
                </div>

                <div class="list-group-item px-0">
                    <div class="row align-items-center">
                        <div class="col-lg-12 col-6 text-truncate">{{ __('Letters') }}</div>
                        <div class="col-lg-12 col-6 text-truncate">{{ number_format($letterCount, 0, __('.'), __(',')) }}</div>
                    </div>
                </div>
            </div>
        </div>
