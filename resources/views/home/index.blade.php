        ...
        <div class="container position-relative z-1">
            <div class="row my-sm-5">
                <div class="col-12 col-lg-6">
                    ...
                    <div class="mt-5">
                        <a href="{{ route('register') }}" class="btn btn-primary btn-lg font-size-lg mt-3 d-inline-flex align-items-center">{{ __('Get started') }}</a>

                        @if(config('settings.demo_url'))
                            <a href="{{ config('settings.demo_url') }}" target="_blank" class="btn btn-outline-primary btn-lg font-size-lg mt-3 d-inline-flex align-items-center mx-2">{{ __('Demo') }} @include('icons.external', ['class' => 'fill-current width-3 height-3 ' . (__('lang_dir') == 'rtl' ? 'mr-2' : 'ml-2')])</a>
                        @endif
                    </div>
                </div>
            </div>
    ...
    <div class="bg-base-1">
        <div class="container position-relative text-center py-5 py-md-7 d-flex flex-column z-1">
            ...
            <div class="m-auto text-center">
                <p class="text-muted font-weight-normal font-size-lg mb-0">{{ __('Reports that help you improve your presence on search engines.') }}</p>
            </div>
            ...
            <div class="row pb-5">
                <div class="col-12 col-lg-6">
                    ...
                    <div class="row mx-lg-n4">
                        <div class="col-12 pt-3 pr-md-3 pl-md-3 pt-lg-4 pr-lg-4 pl-lg-4 mt-4">
            ...
            <div class="container position-relative text-center py-5 py-md-7 d-flex flex-column z-1">
                <div class="flex-grow-1">
                    ...
                    <div class="text-center">
                        ...
                        <div class="m-auto">
                            <p class="font-weight-normal text-muted font-size-lg mb-0">{{ __('Get detailed SEO reports in just seconds.') }}</p>
                        </div>
                    </div>
                </div>
