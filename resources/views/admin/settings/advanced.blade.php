...
<div class="card border-0 shadow-sm">
    ...
    <div class="card-body">
        ...
        <ul class="nav nav-pills d-flex flex-fill flex-column flex-md-row mb-3" id="pills-tab" role="tablist">
            ...
            <li class="nav-item flex-grow-1 text-center">
                <a class="nav-link" id="pills-gcs-tab" data-toggle="pill" href="#pills-gcs" role="tab" aria-controls="pills-gcs" aria-selected="false">{{ __('Google Custom Search Engine') }}</a>
            </li>
            <li class="nav-item flex-grow-1 text-center">
